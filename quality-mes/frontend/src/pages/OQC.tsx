...
function InspectionTab() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setInspections(iRes.data); setProducts(pRes.data); setUsers(uRes.data)
  ...
  const handleCreate = async (values: any) => {
    try {
      await api.post('/oqc/inspections', { ...values, inspection_date: values.inspection_date.toISOString() })
